...
export default function Index() {
  ...
  const income = transactions?.filter((t) => t.is_income).reduce((s, t) => s + Number(t.amount), 0) ?? 0;
  const expenses = transactions?.filter((t) => !t.is_income).reduce((s, t) => s + Number(t.amount), 0) ?? 0;
